...
| #64 | open | js-dos progress | FsService + js-dos engine adapter | no eligible owner | HARNESS GAP packet | save packets | shipped engine save API/explicit boundary absent; identity/artifact/browser restore | yes | HARNESS GAP / BLOCKED EXTERNAL CAPABILITY |
...
| #113 | open | Text editor UX | Text + Monaco | Luna-C claimed | core RED matrix; RTL HARNESS GAP | full matrix | missing title/commands/minimap; canonical Happy DOM cannot mount truthful Monaco CSS runtime | partly | HARNESS GAP + EXACT BROWSER REMAINDER |
| #114 | open | Markdown UX/formatter | Markdown + Monaco host | Luna-C claimed | core RED matrix; RTL HARNESS GAP | full matrix | formatter/commands absent; canonical Happy DOM cannot mount truthful Monaco CSS runtime | partly | HARNESS GAP + EXACT BROWSER REMAINDER |
...
| #123 | open | game artwork | shared ResourcePresentation | Luna-C claimed | HARNESS GAP packet | artwork packets | #190 seam exists but canonical game-artwork metadata contract absent | yes/manual | HARNESS GAP / WAIT FOR CONTRACT |
| #124 | open/blocked | save screenshots | #64 save artifact + Visual | Luna-C claimed | HARNESS GAP packet | preview packets | #64 save representation and explicit save boundary absent | yes | HARNESS GAP / WAIT FOR #64 |
