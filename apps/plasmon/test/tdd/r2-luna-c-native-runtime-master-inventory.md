...
| #64 | open | js-dos progress | FsService + js-dos engine adapter | no eligible owner | none for save lifecycle | save packets | API bridge, identity/artifact, browser restore | yes | WAIT FOR SPECIFIC ENGINE/PRODUCT SEAM |
...
| #96 | open | native app identity assets | Visual asset source + app metadata | Luna-C claimed | package structural tests | identity packet | replace glyphs, package/fallback/visual proof | yes | VERIFIED FULL RED PACKET |
...
| #112 | open r2 | content chrome | Visual + app content surfaces | Luna-C claimed | no common primitive contract test | chrome packets | semantic characterization/visual convergence | yes/manual | CHARACTERIZATION READY |
| #113 | open | Text editor UX | Text + Monaco | Luna-C claimed | document/Monaco tests | full matrix | title/language/commands/minimap and RTL/browser | partly | VERIFIED FULL RED PACKET |
| #114 | open | Markdown UX/formatter | Markdown + Monaco host | Luna-C claimed | render/mode tests | full matrix | formatter/commands and browser interaction | partly | VERIFIED FULL RED PACKET |
