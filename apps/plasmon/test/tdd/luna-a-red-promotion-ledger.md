...
integrated `56752dc3e0fdb21c8c2d13e174c1836d73e6dde8`. #92/PR #223 is merged;
active implementation ownership outside this lane is not modified.
...
| #65 | integrated dependency `2b6984e` | operation-state + RTL #65 | import/paste operation state | merged #208 + recovery #232 | current RTL/headless tests pass | current release promotion green | GREEN IN R2 / #92 CONSUMED |
...
| #110 | integrated PR #151 | existing browser spec + contract | Fs-backed hidden preference | merged #151 | pref/visibility tests pass; browser spec remains unexecuted | deterministic current release green | GREEN IN R2 / BROWSER PENDING |
...
| #92 | merged PR #223 `34e5dae` | former RED + promoted `test/rtl/issue-92.test.tsx` | drag move exposes truthful item operation lifecycle | merged #223 | 3 promoted RTL tests pass in current release | permanent green coverage present | GREEN IN R2 |
...
| #195 | merged #213; current release `56752dc` | #195 characterization and final packet | humble FileManager adapter boundaries | merged #213 | current focused FileManager guards pass | current release source/tests inspected | GREEN IN R2 / #196 CONSUMED |
