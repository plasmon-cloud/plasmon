...
/**
 * Issue #192 intentional RED gates.
 *
 * The existing focused Desktop tests remain the characterization guards for
 * valid persisted NodeId positions and deterministic first allocation. These
 * gates exercise the missing placement-controller reconciliation: allocation
 * currently treats every finite stored point as authoritative, even when it
 * is occupied by another active NodeId or outside the usable workspace.
 */
