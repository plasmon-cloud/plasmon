...
| #64 | Filesystem-backed js-dos progress persistence | unmilestoned/open | js-dos | runtime host + FsService save artifact | none | yes (queue) | js-dos runtime, stable NodeId save contract | VERIFIED CORE RED / INCOMPLETE ACCEPTANCE |
...
| #83 | Headless runtime selection | unmilestoned/open/blocked | js-dos + EmulatorJS | AssociationRegistry/OpenService | none | Lane D owns | handler registration | ACTIVE OWNERSHIP — DO NOT TOUCH (Lane D) |
| #89 | Monaco workers under canonical Program Files path | unmilestoned/open | Monaco | Program Files/bootstrap + package adapter | none | yes (queue) | #200 consumes path | VERIFIED CORE RED / INCOMPLETE ACCEPTANCE |
...
| #96 | Packaged native application identity assets | unmilestoned/open | first-party native apps | packaging + Visual identity | none | yes (queue) | package outputs | CHARACTERIZATION READY |
...
| #112 | Shared first-party native-app chrome | r2/open | all first-party native apps | Visual primitives + app-owned content chrome | none | yes (queue) | #190/#201 and app migrations | CHARACTERIZATION READY — NO HONEST STRUCTURAL RED |
| #113 | Text Monaco desktop-editor parity | unmilestoned/open | Text | Text app + Monaco adapter | none | yes (queue) | #67/#89/#178 | VERIFIED CORE RED / INCOMPLETE ACCEPTANCE |
| #114 | Markdown formatter/commands | unmilestoned/open | Markdown | Markdown app + shared Monaco host | none | yes (queue) | #67/#112/#113 | VERIFIED CORE RED / INCOMPLETE ACCEPTANCE |
...
| #123 | Game artwork thumbnails | unmilestoned/open | Games/Visual | shared ResourcePresentation | none | yes (queue) | #121/#190 | VERIFIED CORE RED / INCOMPLETE ACCEPTANCE |
| #124 | Game save screenshot thumbnails | unmilestoned/open/blocked | Games/runtime + Visual | #64 save artifact + shared presentation | none | yes (queue) | #64 | WAIT FOR DEPENDENCY |
