...
| #64 | Filesystem-backed js-dos progress persistence | unmilestoned/open | js-dos | runtime host + FsService save artifact | none | yes (queue) | actual shipped js-dos save API and stable NodeId artifact | VERIFIED FULL RED PACKET; exact engine API/browser remainder |
...
| #113 | Text Monaco desktop-editor parity | unmilestoned/open | Text | Text app + Monaco adapter | none | yes (queue) | #67/#89/#178 | VERIFIED FULL RED PACKET; exact RTL/Monaco visual remainder |
| #114 | Markdown formatter/commands | unmilestoned/open | Markdown | Markdown app + shared Monaco host | none | yes (queue) | #67/#112/#113 | VERIFIED FULL RED PACKET; exact RTL/Monaco visual remainder |
...
| #123 | Game artwork thumbnails | unmilestoned/open | Games/Visual | shared ResourcePresentation | none | yes (queue) | #121/#190 | WAIT FOR SPECIFIC UNINTEGRATED DEPENDENCY (#190 seam/#121 fixture) |
