...
export const DiagnosticEvent = {
  ...
  NativeApp: {
    ...
    DocumentLoadFailed: event("native-app.document.load.failed"),
    DocumentSaveAsRollbackFailed: event("native-app.document.save-as.rollback.failed"),
    DocumentCloseSaveUnexpectedFailure: event("native-app.document.close-save.unexpected-failure"),
    MarkdownFormatFailed: event("native-app.markdown.format.failed"),
    BrowserTargetResolveFailed: event("native-app.browser.target.resolve-failed"),
    PhotosDecodeFailed: event("native-app.photos.decode.failed"),
    VideoSourceResolveFailed: event("native-app.video.source.resolve-failed"),
    VideoPlaybackError: event("native-app.video.playback.error"),
    VideoPlaybackStartFailed: event("native-app.video.playback.start-failed"),
    ExplorerFavoritesRefreshFailed: event("native-app.explorer.favorites.refresh-failed"),
    RecycleBinBatchPartialFailure: event("native-app.recycle-bin.batch.partial-failure"),
    RecycleBinRefreshAfterActionFailed: event("native-app.recycle-bin.refresh-after-action.failed"),
  },
  Shell: {
