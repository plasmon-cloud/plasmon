...
export const SHELL_COMMAND_HELP: readonly ShellCommandHelp[] = [
  ...
  { name: "cp", usage: "cp [-r|-R] SOURCE DESTDIR", summary: "copy a resource into a directory", details: "Directory copying already follows canonical Plasmon copy semantics; -r/-R are accepted as familiar explicit spellings.", options: [{ flag: "-r", summary: "copy a directory/resource tree" }, { flag: "-R", summary: "same as -r" }] },
  ...
  { name: "tail", usage: "tail [-n N] [FILE]", summary: "print the last lines", details: "Live follow (-f) is intentionally not part of v1.", options: [{ flag: "-n", summary: "print the last N lines instead of 10" }] },
