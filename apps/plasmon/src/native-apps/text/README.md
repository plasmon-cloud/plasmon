...
The #89 packaged worker acceptance separately runs in installed Chromium and Firefox. It verifies the canonical Program Files package URLs, opaque-origin module-Worker construction, real editor/TypeScript worker message exchange, zero worker errors/fallback warnings, and strict BrowserHealth during worker startup.
