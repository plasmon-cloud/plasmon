...
export const optionalCoreBrowserTests = Object.freeze([
  ...
  'test/e2e/plasmon-monaco-packaged-demo.spec.ts',
  'test/e2e/plasmon-monaco-workers-89.spec.ts',
  'test/e2e/plasmon-emulatorjs-proof.spec.ts',
  'test/e2e/plasmon-demo-game.spec.ts',
  'test/e2e/plasmon-markdown-commands-114-demo.spec.ts',
  'test/e2e/plasmon-native-app-chrome-112-demo.spec.ts',
  'test/e2e/plasmon-photos-expand-180-demo.spec.ts',
  'test/e2e/plasmon-text-language-transition-demo.spec.ts',
  'test/e2e/plasmon-text-parity-344-demo.spec.ts',
]);
