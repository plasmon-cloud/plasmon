...
#277 is the temporary quarantine owner for the newly isolated left-preview test. #279 is the separate restoration Issue and requires five consecutive clean first-attempt Specialist passes before the quarantine can be removed.
